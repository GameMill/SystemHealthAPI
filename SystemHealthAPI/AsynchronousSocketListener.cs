...
public class AsynchronousSocketListener {  
    ...
    public static void StartListening() {  
        ...
        IPEndPoint localEndPoint = new IPEndPoint(IPAddress.Any, 9145);  
    ...
    public static void ReadCallback(IAsyncResult ar) {  
        ...
        /* if (bytesRead > 0) {
             ...
             Send(handler, SystemHealthAPI.Program.system.ToString());
        ...
        if (bytesRead > 0)
        {
            ...
            Send(handler, SystemHealthAPI.Program.system.ToString(content,false));
        }
    }  
